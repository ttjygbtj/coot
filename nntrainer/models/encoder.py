...
def make_encoder_module(dim: int, name: str, cfg: Optional[EncoderConfig] = None) -> Optional[paddle.nn.Layer]:
    """
...
class PositionalEncodingSinCos(paddle.nn.Layer):
    """
    ...
    def __init__(self, dim: int, dropout_prob: float = 0., max_len: int = 1000):
        ...
        dimension = paddle.arange(0, dim, dtype='float32')
        ...
        #                       -(mapaddle.log(10000.0) / dim)).float())
