...
class BaseModelManager:
    def __init__(self, cfg: nntrainer.trainer_configs.DefaultExperimentConfig):
        """
        Class to hold all models. This is not a paddle.nn.Layer

        Args:
            cfg: Experiment config.
        """
        # this dict contains all the models
        self.model_dict: Dict[str, paddle.nn.Layer] = {}
    ...
    def get_model_state(self) -> Dict[str, Dict[str, paddle.to_tensor]]:
        """
    ...
    def set_model_state(self, state: Dict[str, Dict[str, paddle.to_tensor]]) -> None:
        """
    ...
    def get_params_opt_simple(self, model: paddle.nn.Layer) -> (
            Tuple[List[Dict[str, Any]], List[str], List[paddle.to_tensor]]):
        """
        Args:
        ...
        Returns:
            Tuple of:
                ...
                List of:
                    parameters
        """
        params_dict: Dict[str, paddle.to_tensor] = dict(model.named_parameters())
        params, param_names, params_flat = [], [], []
