...
def compute_retrieval(data_collector: Dict[str, paddle.to_tensor], key1: str, key2: str, print_fn: Callable = print) -> (
    ...
    if isinstance(emb1, paddle.to_tensor):
        emb1 = emb1.numpy()
    if isinstance(emb2, paddle.to_tensor):
        emb2 = emb2.numpy()
